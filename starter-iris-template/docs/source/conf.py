...
# starter_iris_template documentation build
...
from starter_iris_template import __version__ as release

# -- Project information -----------------------------------------------------

project = "starter_iris_template"
author = "Kedro"
...
htmlhelp_basename = "starter_iris_templatedoc"
...
latex_documents = [
    (
        master_doc,
        "starter_iris_template.tex",
        "starter_iris_template Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "starter_iris_template",
        "Project starter_iris_template codebase.",
        "Nearest-Neighbour",
    )
]
